    ...
    class ActionClient : public rclcpp::Node{
        public:
            ...
            explicit ActionClient(const rclcpp::NodeOptions & options) : Node("action_client", options){
                ...
                this->timer_ = this->create_wall_timer(std::chrono::milliseconds(500), std::bind(&ActionClient::send_goal, this));
            ...
            void send_goal(){
                ...
                if(!this->client_ptr_->wait_for_action_server()){
                    RCLCPP_ERROR(this->get_logger(), "Action server not availabe after waiting");
                    rclcpp::shutdown();
                }
...
RCLCPP_COMPONENTS_REGISTER_NODE(action::ActionClient)
